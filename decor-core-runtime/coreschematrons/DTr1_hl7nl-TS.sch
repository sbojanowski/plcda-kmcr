...
<!-- 
    ...
    Status: draft
-->
<rule abstract="true" id="hl7nl-TS" xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:xs="http://www.w3.org/2001/XMLSchema">
    <extends rule="QTY"/>
    
    <assert role="error" test="(@nullFlavor or @value or *) and not(@nullFlavor and @value)" see="https://docs.art-decor.org/documentation/datatypes/DTr1_hl7nl:TS"
        >dtr1-1-hl7nl-TS: null or value or child element in case of extension</assert>
    ...
    <assert role="error" test="empty($theTS) or ($theTS=$theTSString and $theDateTime castable as xs:dateTime)" see="https://docs.art-decor.org/documentation/datatypes/DTr1_hl7nl:TS"
        >dtr1-2-hl7nl-TS: <value-of select="local-name()"/> "<value-of select="$theTS"/>" is not a valid timestamp.</assert>
</rule>