...
<!-- 
    ...
    Status: draft
-->
<rule abstract="true" id="CS.LANG" xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:xs="http://www.w3.org/2001/XMLSchema">
    <extends rule="CS"/>
    ...
    <assert role="error" test="not(@code) or matches(@code,$RFC3066,'i')" see="https://docs.art-decor.org/documentation/datatypes/DTr1_CS.LANG"
