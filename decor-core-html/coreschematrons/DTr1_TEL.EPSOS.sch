...
<rule abstract="true" id="TEL.EPSOS" xmlns="http://purl.oclc.org/dsdl/schematron">
    ...
    <assert test="not($urlScheme=('tel','fax')) or matches($urlStr,'^\+?[0-9()\.-]+$')" see="https://art-decor.org/mediawiki/index.php?title=DTr1_TEL.EPSOS"
    ...
    <assert test="not($urlScheme=('tel','fax')) or matches(replace($urlStr,'[^\d]',''),'[0-9]+')" see="https://art-decor.org/mediawiki/index.php?title=DTr1_TEL.EPSOS"
