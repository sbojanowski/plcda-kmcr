...
<rule abstract="true" id="II.AT.ATU" xmlns="http://purl.oclc.org/dsdl/schematron">
    ...
    <assert role="error" test="@nullFlavor or @root = '1.2.40.0.10.2.0.2.1'" see="https://docs.art-decor.org/documentation/datatypes/DTr1_II.AT.ATU"
        >dtr1-1-II.AT.ATU: @root SHALL be 1.2.40.0.10.2.0.2.1 if not null</assert>
