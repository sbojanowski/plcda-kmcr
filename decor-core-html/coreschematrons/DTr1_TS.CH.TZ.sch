...
<rule abstract="true" id="TS.CH.TZ" xmlns="http://purl.oclc.org/dsdl/schematron">
    ...
    <assert role="error" test="@nullFlavor or matches(@value,'^[0-9]{4}$|^[0-9]{6}$|^[0-9]{8}$') or contains(@value,'+') or contains(@value,'-')" see="https://art-decor.org/mediawiki/index.php?title=DTr1_TS.CH.TZ"
